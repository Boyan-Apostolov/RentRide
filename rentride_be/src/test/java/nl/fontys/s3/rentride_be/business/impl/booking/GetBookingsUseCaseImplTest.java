...
class GetBookingsUseCaseImplTest {

    @Mock
    private BookingRepository bookingRepository;

    @InjectMocks
    private GetBookingsUseCaseImpl getBookingsUseCase;
    ...
    @Test
    void getBookings_ShouldReturnAllBookings_WhenBookingsExist() {
        when(bookingRepository.findAll()).thenReturn(List.of(bookingEntity1, bookingEntity2));

        List<Booking> result = getBookingsUseCase.getBookings();
